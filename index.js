...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.d8lmf1g.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
    try {
        ...
        app.post('/create-payment_intent', verifyJWT, async(req, res)=>{
